...
PRT_VALUE* PRT_CALL_CONV PrtStringConcat(_In_ PRT_VALUE* str1, _In_ PRT_VALUE* str2)
{
	...
	strncat(ret, str1->valueUnion.str, strlen(str1->valueUnion.str));
	strncat(ret, str2->valueUnion.str, strlen(str1->valueUnion.str));
...
PRT_VALUE* PRT_CALL_CONV PrtCloneValue(_In_ PRT_VALUE* value)
{
	...
	case PRT_VALUE_KIND_STRING: 
	{
		...
		strncpy(copy, value->valueUnion.str, strlen(value->valueUnion.str) + 1);
