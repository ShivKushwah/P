...
{
    public class UnencryptedSendStmt : IPStmt
    {
        public UnencryptedSendStmt(ParserRuleContext sourceLocation, IPExpr machineExpr, IPExpr evt,
            IReadOnlyList<IPExpr> arguments)
        {
            ...
            highSecurityLabel = false; //Since this function only sends to unencrypted machines, it should be low security and regarded to leak secrets
        }
