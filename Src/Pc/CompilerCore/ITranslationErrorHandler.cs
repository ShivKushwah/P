...
namespace Plang.Compiler
{
    public interface ITranslationErrorHandler
    {
        ...
        Exception InformationFlowWhileException(ParserRuleContext location, PLanguageType whileType, bool bodySecurity);
        ...
        Exception InvalidStringExprFormat(PParser.FormattedStringContext context, IToken symbol);
